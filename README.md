# HySecure AWS Infrastructure – Terraform

## Overview
This repository contains **Terraform Infrastructure as Code (IaC)** used to deploy the **HySecure Gateway infrastructure on AWS**.
...
CIDR block is defined in **terraform.tfvars**.
